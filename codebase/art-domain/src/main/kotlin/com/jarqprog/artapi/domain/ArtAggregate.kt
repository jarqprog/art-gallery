...
class ArtAggregate private constructor(
    ...
    override fun toString(): String {
        return "com.jarqprog.artapi.command.domain.ArtAggregate(identifier=$identifier, version=$version, timestamp=$timestamp, author=$author, resource=$resource, addedBy=$addedBy, genre=$genre, status=$status)"
    }
